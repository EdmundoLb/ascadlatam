...
export const levels = [
  ...
  { code: 'EPR',     name: 'Entrenador de Pares en Recuperación', desc: 'Para personas con experiencia vivida en recuperación que brindar apoyo empático y no clínico.',            fee: 30  },
