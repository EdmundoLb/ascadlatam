...
const faqs = [
  ...
  { question: '¿Cómo inicio mi proceso de certificación?', answer: 'El candidato debe seleccionar el nivel de certificación correspondiente a su formación y experiencia, completar la documentación requerida, presentar las referencias profesionales, acreditar las horas de experiencia y formación exigidas, firmar el Código de Ética Profesional y aprobar el examen internacional correspondiente. Para obtener información específica sobre requisitos, fechas de aplicación y procedimientos administrativos, puede comunicarse con el representante de ASCAD LATAM o FLACT en su país.' }
]
