<template>
  <div>
    <section class="page-hero">
      <div class="container">
        ...
        <p class="lead" style="margin-top:20px;">
          Seis niveles de certificación progresivos, desde el acompañamiento inicial hasta la supervisión clínica especializada. Todos alineados con estándares internacionales TAP 21 y el modelo de las 12 funciones del consejero.
        </p>
      </div>
    </section>
      ...
      <div class="container">
        <div class="toc-grid">
          <a href="#comparativa" class="toc-item">
            ...
            <span class="toc-label">Comparativa</span>
            <span class="toc-desc">Ver todos los niveles lado a lado</span>
          </a>
          <a href="#detalles" class="toc-item">
            <span class="toc-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            </span>
            <span class="toc-label">Detalles por nivel</span>
            <span class="toc-desc">Requisitos, competencias y horas</span>
          </a>
          <a href="#proceso" class="toc-item">
            <span class="toc-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
            </span>
            <span class="toc-label">Proceso</span>
          ...
          <a href="#faq" class="toc-item">
            ...
            <span class="toc-label">Preguntas</span>
            <span class="toc-desc">FAQ sobre el proceso</span>
          </a>
        </div>
      </div>
    </section>
          ...
          >
            <div class="cert-header">
              <div class="cert-level">
                ...
                <span class="cert-icon">{{ getLevelIcon(cert.code) }}</span>
              </div>
      ...
      <div class="container">
        <div class="alliance-inner">
          <div class="alliance-text">
            ...
            <h2>Una alianza que <em class="gold">garantiza calidad</em></h2>
            <p>ASCAD LATAM trabaja junto a FLACT, Universidad Gestalt y Aforind para asegurar que cada profesional certificado cumpla con los más altos estándares de calidad, ética y competencia en el campo de las adicciones.</p>
            <router-link to="/aliados" class="btn btn-gold btn-lg" style="margin-top:24px;">Conocer los aliados</router-link>
          </div>
    ...
    <!-- FULLSCREEN MODAL -->
    <div v-if="activeModal" class="cert-modal-overlay" @click.self="closeModal">
      <div class="cert-modal" role="dialog" :aria-label="`Detalles de ${certifications.find(c => c.code === activeModal)?.name}`">
        <button class="modal-close" @click="closeModal" aria-label="Cerrar">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
        </button>
        <div class="modal-header">
          <div class="modal-flact">Programa FLACT de Formación en Adicciones</div>
          ...
          <template v-for="cert in certifications" :key="cert.code">
            <div v-if="cert.code === activeModal" class="modal-content-inner">
              ...
              <div class="axis-blocks">
                <div v-for="axis in cert.competencies" :key="axis.axis" class="axis-block">
              ...
              <div class="cert-actions">
                ...
                <button @click="goToAliados()" class="btn btn-ghost">Más información</button>
              </div>
            </div>
          </template>
        </div>
...
function getLevelIcon(code) {
  const level = levels.value.find(l => l.code === code)
  return level?.icon || '📋'
}

const comparisonData = [
  { code: 'OST',    name: 'Operador Socio-Terapéutico',       desc: 'Nivel inicial de acompañamiento supervisado',        formacion: '80h',    experiencia: '1.000h',  supervision: '100h',    fee: 30,  highlight: false },
  { code: 'EPR',    name: 'Entrenador de Pares',               desc: 'Apoyo desde la experiencia vivida en recuperación',   formacion: '80h',    experiencia: '80h',     supervision: '—',      fee: 30,  highlight: false },
  { code: 'CCAAD I',  name: 'Consejero en Adicciones I',        desc: 'Primer nivel técnico profesional',                     formacion: '120h',   experiencia: '1.500h',  supervision: '60h',    fee: 50,  highlight: false },
  { code: 'CCAAD II', name: 'Consejero en Adicciones II',       desc: 'Competencias avanzadas en consejería',                 formacion: '150h',   experiencia: '2.000h',  supervision: '96h',    fee: 75,  highlight: false },
  { code: 'CCAAD III',name: 'Consejero en Adicciones III',      desc: 'Nivel clínico avanzado con autonomía',                formacion: '170h',   experiencia: '3.000h',  supervision: '120h',   fee: 100, highlight: true  },
  { code: 'CCAAD IV', name: 'Supervisor Clínico IV',           desc: 'Máximo nivel: supervisión y liderazgo',               formacion: '40h',    experiencia: '6.000h',  supervision: '120h',   fee: 125, highlight: false },
]
...
const certifications = [
  ...
  },
  {
    ...
    competencies: [
      ...
      { axis: 'Ejes de Formación del Consejero en Adicciones Inicial – CCAAD I', color: certColors['CCAAD I'].primary, items: [
      ...
      { axis: 'Perfil Profesional', color: certColors['CCAAD I'].accent, items: [
        'El Consejero en Adicciones CCAAD I brinda apoyo estructurado y acompañamiento terapéutico desde una perspectiva ética, técnica y centrada en la persona, fortaleciendo procesos de recuperación y bienestar integral.'
      ]}
    ],
  ...
  },
  {
    ...
    name: 'Técnico en Consejería en Adicciones',
    summary: 'Competencias avanzadas en consejería con mayor responsabilidad clínica.',
    description: 'Competencias avanzadas en consejería con mayor responsabilidad clínica. Realiza evaluaciones integrales, diseña planes de tratamiento individualizados y coordina redes de apoyo.',
    competencies: [
      ...
      { axis: 'Ejes de Formación del Técnico en Consejería en Adicciones – CCAAD II', color: certColors['CCAAD II'].primary, items: [
        'Comprensión del Trastorno por Uso de Sustancias Psicoactivas',
        'Selección, Evaluación y Participación',
        'Planificación, Colaboración y Derivación del Tratamiento',
        'Consejería',
      ...
      { axis: 'Perfil Profesional', color: certColors['CCAAD II'].accent, items: [
        'El Técnico en Consejería en Adicciones CCAAD II actúa con empatía, responsabilidad y compromiso humano, contribuyendo al acompañamiento terapéutico y fortaleciendo procesos de recuperación desde una atención ética, organizada y centrada en la dignidad de la persona.'
      ]}
    ],
  ...
  },
  {
    ...
    name: 'Licenciado Profesional en Consejería Avanzada No Clínica',
    summary: 'Nivel clínico avanzado con evaluación biopsicosocial.',
    description: 'Nivel clínico avanzado con competencias para la evaluación biopsicosocial, diagnósticos funcionales y manejo de casos complejos.',
    competencies: [
      ...
      { axis: 'Ejes de Formación del Consejero Avanzado – CCAAD III', color: certColors['CCAAD III'].primary, items: [
        'Comprensión del Trastorno por Uso de Sustancias Psicoactivas',
        'Selección, Evaluación y Participación',
        'Planificación, Colaboración y Derivación del Tratamiento',
        'Consejería Avanzada',
      ...
      { axis: 'Perfil Profesional', color: certColors['CCAAD III'].accent, items: [
        'El profesional CCAAD III actúa como líder en procesos de acompañamiento avanzado no clínico, promoviendo la recuperación integral, el fortalecimiento de redes de apoyo y la atención centrada en la persona, siempre dentro de los límites éticos y técnicos de su profesión.'
      ]}
    ],
  ...
  },
  {
    ...
    summary: 'Máximo nivel: supervisión clínica y liderazgo de equipos.',
    description: 'Máximo nivel de la ruta de certificación. Diseña sistemas de supervisión, lidera equipos clínicos, garantiza la calidad asistencial y promueve la formación continua.',
    competencies: [
      { axis: 'Competencias Principales', color: certColors['CCAAD IV'].primary, items: [
        ...
        'Definición de roles, límites y alcances de la supervisión clínica.',
        ...
        'Evaluación objetiva del desempeño clínico y profesional.',
      ...
      { axis: 'Ejes de Formación del Supervisor Clínico Certificado – CCAAD IV', color: certColors['CCAAD IV'].primary, items: [
    ...
    hours: [{ value: '40h', label: 'Formación en supervisión' }, { value: '2.000h', label: 'Como consejero' }, { value: '4.000h', label: 'Supervisión clínica' }, { value: '120h', label: 'Supervisión recibida' }]
  }
]
...
const faqs = [
  ...
  { question: '¿Hay beneficios para miembros de FLACT?', answer: 'Sí, los profesionales afiliados a comunidades terapéuticas miembros de FLACT cuentan con tarifs preferenciales del 20% en la cuota de certificación, acceso a programas de formación continua exclusivos y un proceso de verificación de experiencia simplificado.' },
...
const consortium = [
  ...
  { name: 'FLACT', icon: '🌎', role: 'Comunidades Terapéuticas' },
  { name: 'Universidad Gestalt', icon: '🎓', role: 'Formación Académica' },
  { name: 'Aforind', icon: '🔬', role: 'Investigación' },
]
</script>
...
.cert-title-area h3 { font-family: var(--font-display); font-size: 1.125rem; color: var(--text); margin-bottom: 4px; line-height: 1.2; }
...
.axis-header { display: flex; align-items: center; gap: 10px; margin-bottom: 10px; }
.axis-name {
  font-family: var(--font-mono);
  font-size: .625rem;
  font-weight: 700;
...
.axis-items { display: flex; flex-direction: column; gap: 6px; }
.axis-items li { display: flex; align-items: flex-start; gap: 8px; font-size: .8125rem; color: var(--text-secondary); line-height: 1.5; }
