...
.flact-intro h2 { margin-bottom: 20px; }
...
.flact-cta h3 { font-size: 1.5rem; margin-bottom: 16px; }
.flact-cta p { color: var(--text-secondary); max-width: 560px; margin: 0 auto 32px; line-height: 1.7; }
